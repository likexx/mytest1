...
func (c *vvvClient) SayHello456(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/vvv.vvv.vvv/SayHello456", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedVvvServer) SayHello456(context.Context, *HelloRequest) (*HelloReply, error) {
...
func _Vvv_SayHello456_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VvvServer).SayHello456(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vvv.vvv.vvv/SayHello456",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VvvServer).SayHello456(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Vvv_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Vvv_SayHello456_Handler,
		},
	},
